...
export function shepherdSettings(guiMain: dat.GUI, guiColorManager: dat.GUI) {
    let checkbox = document.getElementById('cb1') as HTMLInputElement | null;
    ...
    const tour: Shepherd.Tour = new Shepherd.Tour({
        ...
        defaultStepOptions: {
            ...
            when: {
                show: function(this: Shepherd.TourStep) {
    ...
    function createPagination(step: Shepherd.TourStep): string {
